...
import com.stephanlaas.mapit.Adapter.DirectionStepAdapter;
import com.stephanlaas.mapit.Constant.AllConstant;
import com.stephanlaas.mapit.Fragments.HomeFragment;
import com.stephanlaas.mapit.Model.DirectionPlaceModel.DirectionLegModel;
import com.stephanlaas.mapit.Model.DirectionPlaceModel.DirectionResponseModel;
import com.stephanlaas.mapit.Model.DirectionPlaceModel.DirectionRouteModel;
...
import com.stephanlaas.mapit.databinding.ActivityDirectionBinding;
import com.stephanlaas.mapit.databinding.BottomSheetLayoutBinding;
    ...
    private void getDirection(String mode) {
        ...
        if (isLocationPermissionOk) {
            ...
            String url = "https://maps.googleapis.com/maps/api/directions/json?" +
                    ...
                    "&mode=" + mode +
                    "&key=" + getResources().getString(R.string.CONSUMER_KEY);
...
//                                getSupportActionBar().setTitle(routeModel.getSummary());
                                ...
                                if (HomeFragment.systemVal.equals("true")){
                                    ...
                                    test = legModel.getDistance().getText();
                                    String newWord = test.replace("km"," ");
                                    double miles = Double.parseDouble(newWord)/1.609;
                                    bottomSheetLayoutBinding.txtSheetDistance.setText(new DecimalFormat("#.##").format(miles) + " miles");
