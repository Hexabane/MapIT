package com.stephanlaas.mapit.Fragments;
...
import com.stephanlaas.mapit.Activity.DirectionActivity;
import com.stephanlaas.mapit.Adapter.GooglePlaceAdapter;
import com.stephanlaas.mapit.Adapter.InfoWindowAdapter;
import com.stephanlaas.mapit.BuildConfig;
import com.stephanlaas.mapit.Constant.AllConstant;
import com.stephanlaas.mapit.GooglePlaceModel;
import com.stephanlaas.mapit.Model.GooglePlaceModel.GoogleResponseModel;
import com.stephanlaas.mapit.NearLocationInterface;
import com.stephanlaas.mapit.Permissions.AppPermissions;
import com.stephanlaas.mapit.PlaceModel;
import com.stephanlaas.mapit.R;
import com.stephanlaas.mapit.SavedPlaceModel;
import com.stephanlaas.mapit.Utility.LoadingDialog;
import com.stephanlaas.mapit.WebServices.RetrofitAPI;
import com.stephanlaas.mapit.WebServices.RetrofitClient;
import com.stephanlaas.mapit.databinding.FragmentHomeBinding;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback ,GoogleMap.OnMarkerClickListener ,NearLocationInterface{
    ...
    public static String systemVal;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding.edtPlaceName.setOnKeyListener(new View.OnKeyListener() {
            @Override
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_DOWN) &&
                    ...
                    if (placeName.contains(" ")){
                        placeNameNew = placeName.replace(" ", "_");
                    }else{
                        placeNameNew = placeName.toLowerCase(Locale.ROOT).trim();
                    }

                    getPlaces(placeNameNew);
                    return true;
                }
                return false;
            }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (mAppPermissions.isLocationOk(requireContext())) {
    ...
    public void dateRec(){
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                systemVal = snapshot.child("notificationEnable").getValue().toString();
            }
                        ...
                        if (response.errorBody() == null) {
                            if (response.body() != null) {
                                if (response.body().getGooglePlaceModelList() != null && response.body().getGooglePlaceModelList().size() > 0) {
                                    ...
                                    Toast.makeText(getContext(), "Invalid Landmark Type", Toast.LENGTH_SHORT).show();
                                }
                            }
            ...
            locationReference.child(googlePlaceModel.getPlaceId()).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (!snapshot.exists()) {
                        ...
                        if (googlePlaceModel.getRating() == null && googlePlaceModel.getUserRatingsTotal() == null){
                            SavedPlaceModel savedPlaceModel = new SavedPlaceModel(googlePlaceModel.getName(), googlePlaceModel.getVicinity(),
                                    googlePlaceModel.getPlaceId(), null,
                                    0,
    ...
    public void onDirectionClick(GooglePlaceModel googlePlaceModel) {
        ...
        startActivity(intent);
        Toast.makeText(requireContext(), "DirectionClicked", Toast.LENGTH_SHORT).show();
    }
