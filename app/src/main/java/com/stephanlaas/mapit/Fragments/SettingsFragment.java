...
import com.stephanlaas.mapit.Activity.LoginActivity;
import com.stephanlaas.mapit.Activity.MainActivity;
import com.stephanlaas.mapit.Activity.SignUpActivity;
import com.stephanlaas.mapit.Activity.SplashActivity;
...
import com.stephanlaas.mapit.databinding.FragmentSettingsBinding;
...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Switch sw = (Switch) binding.getRoot().findViewById(R.id.swSystem);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (snapshot.child("notificationEnable").getValue().equals(false)){
                        sw.setChecked(true);
                    }
                    if (snapshot.child("notificationEnable").getValue().equals(true)){
                        sw.setChecked(false);
                    }
        ...
        sw.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    databaseReference.child(firebaseAuth.getUid()).child("notificationEnable").setValue(false);

                } else {
                    // The toggle is disabled
                    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Users");

                    databaseReference.child(firebaseAuth.getUid()).child("notificationEnable").setValue(true);
                }
            }
        });
